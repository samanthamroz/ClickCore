...
public class InteractionTriggerer : IInteractionTriggerer {
    private Interactable currentInteractableBeingClicked;
    private Interactable lastInteractableClicked;
    private Camera cam;
    ...
    private bool TryUpdateCurrentInteractable(Vector2 mouseScreenPosition) {
        ...
        if (Physics.Raycast(ray, out RaycastHit hit)) {
            ...
            if (hit.collider.gameObject.TryGetComponent(out Interactable foundInteractable)) {
